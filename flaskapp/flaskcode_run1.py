...
items_found_info = db['food_items_found']
...
def get_resturant_menu():
    ...
    while data != None:
        print data['b_id']
        if data['b_id'] == "fAJYeE4Q6vwVPGkk1MWCoQ":
            data = fetchone_dict(cursor)
            continue
        ...
        json_data = {
                        ...
                        #"api_key": "d5a8998a4ef06635d6724e7feab8a0e1f38db07b",
                        "api_key": "1c8ccfe8f24289df0c05249dcff3f7b873f6b1a8",
...
if __name__ == "__main__":
    ...
    #mongo = PyMongo(app)
    #app.config['MONGO_DBNAME'] = '6339project'
